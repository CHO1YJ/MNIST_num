...
for i in range(1, 501): # 숫자 이미지 0에 대해서 500개의 Training set을 특징 set으로 변환
    ...
    x0_0 = feature_3(temp_image_0)
    x1_0 = feature_4(temp_image_0)
    x2_0 = feature_5(temp_image_0)
    x3_0 = feature_6(temp_image_0)
    x4_0 = feature_7(temp_image_0)
...
for i in range(1, 501): # 숫자 이미지 1에 대해서 500개의 Training set을 특징 set으로 변환
    ...
    x0_1 = feature_3(temp_image_1)
    x1_1 = feature_4(temp_image_1)
    x2_1 = feature_5(temp_image_1)
    x3_1 = feature_6(temp_image_1)
    x4_1 = feature_7(temp_image_1)
...
for i in range(1, 501): # 숫자 이미지 2에 대해서 500개의 Training set을 특징 set으로 변환
    ...
    x0_2 = feature_3(temp_image_2)
    x1_2 = feature_4(temp_image_2)
    x2_2 = feature_5(temp_image_2)
    x3_2 = feature_6(temp_image_2)
    x4_2 = feature_7(temp_image_2)
